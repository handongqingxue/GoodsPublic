...
public class PublicServiceImpl implements PublicService {
	...
	public int addHtmlGoodsJYDG(HtmlGoodsJYDG htmlGoodsJYDG) {
		// TODO Auto-generated method stub
		return publicDao.addHtmlGoodsJYDG(htmlGoodsJYDG);
	}
	...
	public int editHtmlGoodsSMYL(HtmlGoodsSMYL htmlGoodsSMYL) {
		// TODO Auto-generated method stub
		return publicDao.editHtmlGoodsSMYL(htmlGoodsSMYL);
	}

	@Override
	public int editHtmlGoodsJYDG(HtmlGoodsJYDG htmlGoodsJYDG) {
		// TODO Auto-generated method stub
		return publicDao.editHtmlGoodsJYDG(htmlGoodsJYDG);
	}
	...
	public int queryHtmlGoodsJYDGForInt(String accountId) {
		// TODO Auto-generated method stub
		return publicDao.queryHtmlGoodsJYDGForInt(accountId);
	}
	...
	public List<HtmlGoodsJYDG> queryHtmlGoodsJYDGList(String accountId, int page, int rows, String sort, String order) {
		// TODO Auto-generated method stub
		return publicDao.queryHtmlGoodsJYDGList(accountId, (page-1)*rows, rows, sort, order);
	}
	...
	public HtmlGoodsJYDG getHtmlGoodsJYDG(String goodsNumber, String accountNumber) {
		// TODO Auto-generated method stub
		return publicDao.getHtmlGoodsJYDG(goodsNumber,accountNumber);
	}
	...
	public int deleteHtmlGoodsSMYLByIds(String ids) {
		...
		int count=0;
		List<String> idList = Arrays.asList(ids.split(","));
		count=publicDao.deleteHtmlGoodsSMYLByIds(idList);
		return count;
	}
	...
	public int deleteHtmlGoodsJYDGByIds(String ids) {
		...
		int count=0;
		List<String> idList = Arrays.asList(ids.split(","));
		count=publicDao.deleteHtmlGoodsJYDGByIds(idList);
		return count;
	}
	...
	public int addLoginVisitRecord(LoginVisitRecord lvr) {
		// TODO Auto-generated method stub
		return publicDao.addLoginVisitRecord(lvr);
	}

	@Override
	public int deleteLimitedLoginVisitRecord() {
		// TODO Auto-generated method stub
		int count=publicDao.getLimitedLoginVisitRecordCount();
		if(count>0) {
			List<LoginVisitRecord> limitedList=publicDao.selectLimitedLoginVisitRecord();
			for (LoginVisitRecord limitedLVR : limitedList) {
				String uuid=limitedLVR.getUuid();
				deleteLoginVisitRecordByUuid(uuid);
			}
		}
		return 0;
	}
	
	public void deleteLoginVisitRecordByUuid(String uuid) {
		// TODO Auto-generated method stub
		publicDao.deleteLoginVisitRecordByUuid(uuid);
		String filePath="D:/resource/GoodsPublic/LoginQrcode/"+uuid+".jpg";
	...
	public int updateLVRLoginByUuid(String openId, String uuid) {
		// TODO Auto-generated method stub
		return publicDao.updateLVRLoginByUuid(openId,uuid);
	}
