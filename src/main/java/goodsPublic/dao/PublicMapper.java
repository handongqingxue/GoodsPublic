...
public interface PublicMapper {
	...
	*/
	...
	public List<LoginVisitRecord> selectLimitedLoginVisitRecord();

	public int getLimitedLoginVisitRecordCount();

	public int deleteLoginVisitRecordByUuid(@Param("uuid") String uuid);
