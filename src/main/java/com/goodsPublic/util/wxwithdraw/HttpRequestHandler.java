...
public class HttpRequestHandler
{
     ...
     */
    private static void initCert(String path, WxWithDrawConfig config)
     ...
     * @throws KeyManagementException
     */
    public static String httpsRequest(String url, String xmlObj, WxWithDrawConfig config, String path)
        throws IOException, KeyStoreException, UnrecoverableKeyException,
        NoSuchAlgorithmException, KeyManagementException
    {
        // 加载证书
