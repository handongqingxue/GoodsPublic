...
$(function(){
	...
	tab1=$("#tab1").datagrid({
		...
		columns:[[
			{field:"productName",title:"标题",width:200},
            {field:"gmtCreate",title:"创建时间",width:200},
            {field:"id",title:"操作",width:150,formatter:function(value,row){
            	var str="<a href=\"${pageContext.request.contextPath}/merchant/main/goBrowseHtmlGoodsJYDG?goodsNumber="+row.goodsNumber+"&accountNumber="+row.accountNumber+"\">详情</a>"
