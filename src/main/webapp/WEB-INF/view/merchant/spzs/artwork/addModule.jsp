...
<link rel="stylesheet" href="<%=basePath %>/resource/css/spzs/artwork/addModule.css" />
			...
			<table>
				<tr>
					<td class="file_td" id="file_td1_1">
						<img class="delete_img" alt="" src="/GoodsPublic/resource/images/004.png" onclick="deleteImage1(this);">
						<img class="item_img" id="img1_1" alt="" src="/GoodsPublic/resource/images/spzs/f21c462d8e78cbe6f31d4b8c67a0560e.png">
					</td>
					<td id="upload_td">
			...
			<table>
				<tr>
					<td class="file_td" id="file_td2_1">
						<img class="delete_img" alt="" src="/GoodsPublic/resource/images/004.png" onclick="deleteImage2(this);">
						<img class="item_img" id="img2_1" alt="" src="/GoodsPublic/resource/images/spzs/a61777ec9042bb003308d961f185a4e1.png">
						<!-- 
...
<div class="middle_div" id="middle_div">
	...
	<div class="spxq_div" id="spxq_div">
		<table class="spxq_tab" id="spxq_tab">
			<tr class="head_tr">
				<td class="spxq_td" colspan="2">参数</td>
